...
vector<Quantity> QCDPred(){
  ...
  if(z.splitTF){
    z.printYieldsTableLatex({"_DATA","QCD_data","_QCDTF", "_TF", "_QCDTF_CR_to_SR_noextrap", "_QCDTF_SR_extrap", "_pred"}, labelMap, "yields_qcd_hm_16.tex","hm", digits);
  }else{
  ...
  c->Print(z.config.outputdir+"validation_16.png");
  //c->Print(z.config.outputdir+"validation_16.C");
