...
void orig_smear(){
  ...
  TH1* ht_ori = new TH1D("ht_ori","",60,100,6000);
  TH1* ht_sme = new TH1D("ht_sme","",60,100,6000);
  ...
  TString samples[2]={"root://cmseos.fnal.gov//eos/uscms/store/user/mkilpatr/13TeV/smearComp_2016_nano/qcd_orig_tree.root","root://cmseos.fnal.gov//eos/uscms/store/user/mkilpatr/13TeV/smearComp_store_smear/qcd_smear_tree.root"};
