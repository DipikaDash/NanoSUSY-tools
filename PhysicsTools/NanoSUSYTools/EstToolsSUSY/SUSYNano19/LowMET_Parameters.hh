...
BaseConfig lepConfig(){
  ...
  if (ADD_LEP_TO_MET){
    config.addSample("singlelep",        "Data",          inputdir+"met", 		   "1.0",       datasel + trigLepCR + lepcrsel);
    ...
    config.addSample("tW-2016",          "tW",            inputdir+"tW",              onelepcrwgt, datasel + trigLepCR + lepcrsel);
    config.addSample("ttW-2016",         "ttW",           inputdir+"ttW",             onelepcrwgt, datasel + trigLepCR + lepcrsel);
//    config.addSample("qcd",         "QCD",           "lepcr/qcd",             onelepcrwgt, datasel + trigLepCR + lepcrsel);
  }else{
    config.addSample("singlelep",        "Data",          inputdir+"met",                   "1.0",          datasel + trigSR + revert_vetoes);
    config.addSample("singlelep-2016",   "Data 2016",     inputdir+"met_2016",              "1.0",          datasel + trigSR + revert_vetoes);
    config.addSample("ttbar-2016",       "t#bar{t}",      inputdir+"ttbar",           lepselwgt+"*ISRWeight",      datasel + revert_vetoes);
  }

  // samples for sr categories
  config.addSample("ttbar-2016-sr",       "t#bar{t}",      inputdir+"ttbar",                lepvetowgt+"*ISRWeight", datasel + vetoes);
  config.addSample("diboson-2018postHEM-sr", "Diboson",       inputdir+"diboson",           lepvetowgt_postHEM, dataselHEM + vetoes);
...
BaseConfig qcdConfig(){
 ...
 config.addSample("data-cr",     "Data",             "data_2016",          "1.0",      datasel + trigSR + vetoes + dphi_invert);
  config.addSample("qcd-cr",      "QCD",              "qcd_smearw_2016",       qcdwgt,      datasel + trigSR + dphi_invert + qcdSpikeRemovals);

  config.addSample("qcd-withveto-cr",  "QCD",         "qcd_smearw_2016",       qcdvetowgt,  datasel + trigSR + vetoes + dphi_invert + qcdSpikeRemovals);
  config.addSample("qcd-withveto-sr",  "QCD",         "qcd_smearw_2016",       qcdvetowgt,  datasel + trigSR + vetoes + qcdSpikeRemovals);
  ...
  config.addSample("qcd-norm",       "QCD",           "qcd_smearw_2016",       lepselwgt,   datasel + trigSR + revert_vetoes + dphi_cut + qcdSpikeRemovals);

  // qcdsr                                                                                                                                              
  config.addSample("qcd-sr",         "QCD",           "qcd_smearw_2016",       qcdwgt,      datasel + trigSR + qcdSpikeRemovals);
...
BaseConfig sigConfig(){
  ...
  config.addSample("znunu-raw-sr",       "Z#rightarrow#nu#nu",   "znunu_2016",    lepvetowgt_no_wtopsf, datasel + trigSR + vetoes);
  config.addSample("ttbar-raw-sr",       "t#bar{t}",      "ttbar_2016",           lepvetowgt_no_wtopsf, datasel + trigSR + vetoes);
  config.addSample("wjets-raw-sr",       "W+jets",        "wjets_2016",           lepvetowgt_no_wtopsf, datasel + trigSR + vetoes);
  config.addSample("minor-raw-sr",       "minor",         "minor_2016",           lepvetowgt_no_wtopsf, datasel + trigSR + vetoes);
  config.addSample("qcd-raw-sr",         "QCD",           "qcd_smearw_2016",      lepvetowgt_no_wtopsf, datasel + trigSR + vetoes);
