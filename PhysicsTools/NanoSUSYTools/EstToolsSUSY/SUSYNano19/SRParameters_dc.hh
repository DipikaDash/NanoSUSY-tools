...
namespace EstTools{
  ...
  const TString inputdir_sig  = "root://cmseos.fnal.gov//eos/uscms/store/user/mkilpatr/13TeV/nanoaod_T2tt_corridor_2017_100119/";
...
const TString wgtvar = lumistr_2016+"*1000*Stop0l_evtWeight*puWeight*Stop0l_trigger_eff_MET_loose_baseline_QCD*BTagWeight*PrefireWeight*topTagWeight*restopTagWeight*wTagWeight*softbTagWeight"; //2016
const TString wgtvar_BtoE = lumistr_2017RunBtoE+"*1000*Stop0l_evtWeight*17BtoEpuWeight*Stop0l_trigger_eff_MET_loose_baseline_QCD*BTagWeight*PrefireWeight*topTagWeight*restopTagWeight*wTagWeight*softbTagWeight"; //2017
const TString wgtvar_F = lumistr_2017RunF+"*1000*Stop0l_evtWeight*17FpuWeight*Stop0l_trigger_eff_MET_loose_baseline_QCD*BTagWeight*PrefireWeight*topTagWeight*restopTagWeight*wTagWeight*softbTagWeight"; //2017
const TString wgtvar_preHEM = lumistr_2018PreHEM+"*1000*Stop0l_evtWeight*puWeight*Stop0l_trigger_eff_MET_loose_baseline_QCD*BTagWeight*topTagWeight*restopTagWeight*wTagWeight*softbTagWeight"; //2018
const TString wgtvar_postHEM = lumistr_2018PostHEM+"*1000*Stop0l_evtWeight*puWeight*Stop0l_trigger_eff_MET_loose_baseline_QCD*BTagWeight*topTagWeight*restopTagWeight*wTagWeight*softbTagWeight"; //2018
const TString wgtvarsr = lumistr_2016+"*1000*Stop0l_evtWeight*puWeight*Stop0l_trigger_eff_MET_loose_baseline*BTagWeight*PrefireWeight*topTagWeight*restopTagWeight*wTagWeight*softbTagWeight"; //2016                                                                                                                                             
  const TString wgtvar_BtoEsr = lumistr_2017RunBtoE+"*1000*Stop0l_evtWeight*17BtoEpuWeight*Stop0l_trigger_eff_MET_loose_baseline*BTagWeight*PrefireWeight*topTagWeight*restopTagWeight*wTagWeight*softbTagWeight"; //2017                                                                                                                            
  const TString wgtvar_Fsr = lumistr_2017RunF+"*1000*Stop0l_evtWeight*17FpuWeight*Stop0l_trigger_eff_MET_loose_baseline*BTagWeight*PrefireWeight*topTagWeight*restopTagWeight*wTagWeight*softbTagWeight"; //2017                                                                                                                                      
  const TString wgtvar_preHEMsr = lumistr_2018PreHEM+"*1000*Stop0l_evtWeight*puWeight*Stop0l_trigger_eff_MET_loose_baseline*BTagWeight*topTagWeight*restopTagWeight*wTagWeight*softbTagWeight"; //2018                                                                                                                                           
  const TString wgtvar_postHEMsr = lumistr_2018PostHEM+"*1000*Stop0l_evtWeight*puWeight*Stop0l_trigger_eff_MET_loose_baseline*BTagWeight*topTagWeight*restopTagWeight*wTagWeight*softbTagWeight";
...
BaseConfig srConfig(){
  ...
  config.addSample("data",        	     "Data",          "data_run2",    		 "1.0",      datasel + trigSR + vetoes);
...
BaseConfig qcdcrSignalConfig(TString signal){
  BaseConfig     config;

  config.inputdir = "";
  config.outputdir = outputdir+"/QCDB";

  // add signals in lepcr
  config.addSample("qcdcr_"+signal,   signal,          inputdir_sig+signal,   siglepselwgt, datasel + trigSR + revert_vetoes);
...
map<std::string, std::string> makeBinMap(TString control_region){
  ...
  const auto &crMapping = control_region=="phocr" ? phocrMapping : (control_region=="qcdcr" ? qcdcrMapping : lepcrMapping);
...
map<std::string, std::string> qcdcrBinNumMap = makeNumBinMap();
map<std::string, std::string> qcdcrUnitNumMap = makeNumUnitMap();
