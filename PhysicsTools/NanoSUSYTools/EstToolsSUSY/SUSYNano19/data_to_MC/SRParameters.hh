...
// lumi and base weight
  ...
  // lumi and base weight                                                                                                                                                                
  const TString wgtvar = lumistr_2016+"*1000*Stop0l_evtWeight*puWeight*BTagWeight*PrefireWeight*topTagWeight*restopTagWeight*wTagWeight*softbTagWeight"; //2016                     
  const TString wgtvar_BtoE = lumistr_2017RunBtoE+"*1000*Stop0l_evtWeight*17BtoEpuWeight*BTagWeight*PrefireWeight*topTagWeight*restopTagWeight*wTagWeight*softbTagWeight"; //2017
  const TString wgtvar_F = lumistr_2017RunF+"*1000*Stop0l_evtWeight*17FpuWeight*BTagWeight*PrefireWeight*topTagWeight*restopTagWeight*wTagWeight*softbTagWeight"; //2017         
  const TString wgtvar_preHEM = lumistr_2018PreHEM+"*1000*Stop0l_evtWeight*puWeight*BTagWeight*topTagWeight*restopTagWeight*wTagWeight*softbTagWeight"; //2018                      
  const TString wgtvar_postHEM = lumistr_2018PostHEM+"*1000*Stop0l_evtWeight*puWeight*BTagWeight*topTagWeight*restopTagWeight*wTagWeight*softbTagWeight"; //2018                 
  // photon trigger eff.                                                                                                                                                         
  const TString phowgt = wgtvar;
  // Tag-and-Probe Lepton SF                                                                                                                                                       

  const TString lepvetowgt =      wgtvar +"*MuSF*ElecSF*TaSF";
  const TString lepselwgt  =      wgtvar +"*Stop0l_trigger_eff_MET_loose_baseline*MuSF*ElecSF*TaSF";
  const TString lepvetowgt_BtoE =      wgtvar_BtoE +"*MuSF*ElecSF*TaSF";
  const TString lepselwgt_BtoE  =      wgtvar_BtoE +"*Stop0l_trigger_eff_MET_loose_baseline*MuSF*ElecSF*TaSF";
  const TString lepvetowgt_F =         wgtvar_F +"*MuSF*ElecSF*TaSF";
  const TString lepselwgt_F  =         wgtvar_F +"*Stop0l_trigger_eff_MET_loose_baseline*MuSF*ElecSF*TaSF";
  const TString lepvetowgt_preHEM =       wgtvar_preHEM +"*MuSF*ElecSF*TaSF";
  const TString lepselwgt_preHEM  =       wgtvar_preHEM +"*Stop0l_trigger_eff_MET_loose_baseline*MuSF*ElecSF*TaSF";
  const TString lepvetowgt_postHEM =      wgtvar_postHEM +"*MuSF*ElecSF*TaSF";
...
const TString datasel = " && Pass_EventFilter && Pass_HT && Pass_JetID && Pass_CaloMETRatio && restopTagWeight >=0 && restopTagWeight <=2 ";
  const TString sdatasel ="&& Pass_EventFilter && Pass_HT && Pass_JetID && Pass_CaloMETRatio ";
const TString dataselHEM = " && Pass_EventFilter && Pass_HT && Pass_JetID && Pass_CaloMETRatio && restopTagWeight >=0 && restopTagWeight <=2 && Pass_exHEMVeto20";
const TString sdataselHEM = " && Pass_EventFilter && Pass_HT && Pass_JetID && Pass_CaloMETRatio && Pass_exHEMVeto20";
...
std::map<TString, TString> cutMap = []{
    ...
    std::map<TString, TString> cmap = {
        ...
        {"hmNoDPhi",    "Stop0l_ISRJetPt <=200 && Stop0l_nbtags>=1"},
...
std::map<TString, TString> lepcrMapping {
  //---------- low deltaM ----------
  // 0b, 0 or >=1 ivf
  {"lm_nb0_nivf0_highptisr_nj2to5",              "lm_nb0_nivf0_highptisr"},
  {"lm_nb0_nivf0_highptisr_nj6",                 "lm_nb0_nivf0_highptisr"},
  {"lm_nb0_nivf1_highptisr_nj2to5",              "lm_nb0_nivf1_highptisr"},
  {"lm_nb0_nivf1_highptisr_nj6",                 "lm_nb0_nivf1_highptisr"},
  ...
  {"lm_nb2_lowmtb_lowptisr_lowptb12",            "lm_nb2_lowmtb_lowptisr_lowptb12"},
  {"lm_nb2_lowmtb_lowptisr_medptb12",            "lm_nb2_lowmtb_lowptisr_medptb12"},
  {"lm_nb2_lowmtb_lowptisr_highptb12_nj7",       "lm_nb2_lowmtb_lowptisr_highptb12"},
  {"lm_nb2_lowmtb_highptisr_lowptb12",           "lm_nb2_lowmtb_highptisr_lowptb12"},
  {"lm_nb2_lowmtb_highptisr_medptb12",           "lm_nb2_lowmtb_highptisr_medptb12"},
  {"lm_nb2_lowmtb_highptisr_highptb12_nj7",      "lm_nb2_lowmtb_highptisr_highptb12"},
  //---------- low deltaM ----------


  //---------- high deltaM ----------
  // low mtb
  {"hm_nb1_lowmtb_nj7_nrtgeq1",                  	"hm_nb1_lowmtb"},
  {"hm_nb2_lowmtb_nj7_nrtgeq1",			 	"hm_nb2_lowmtb"},
...
BaseConfig qcdConfig(){
  ...
  // qcdcr
  config.addSample("data-16-cr",     "Data",             "data_2016",  "1.0",      sdatasel + trigSR + vetoes + dphi_invert);
  config.addSample("qcd-16-cr",      "QCD",              "qcd_smear_2016",       qcdwgt,      datasel + dphi_invert + qcdSpikeRemovals);
  config.addSample("qcd-withveto-16-cr",  "QCD",         "qcd_smear_2016",       qcdvetowgt,  datasel + vetoes + dphi_invert + qcdSpikeRemovals);
  config.addSample("qcd-withveto-16-sr",  "QCD",         "qcd_smear_2016",       qcdvetowgt,  datasel + vetoes + qcdSpikeRemovals);
  config.addSample("data-17BtoE-cr",     "Data",         "data_2017BtoE",  "1.0",      sdatasel + trigSR + vetoes + dphi_invert);
  config.addSample("data-17F-cr",     "Data",             "data_2017F",  "1.0",      sdatasel + trigSR + vetoes + dphi_invert);
  config.addSample("qcd-17BtoE-cr",      "QCD",       "qcd_smear_2017",       qcdwgt_BtoE,      datasel + dphi_invert + qcdSpikeRemovals);
  config.addSample("qcd-withveto-17BtoE-cr",  "QCD",  "qcd_smear_2017",       qcdvetowgt_BtoE,  datasel + vetoes + dphi_invert + qcdSpikeRemovals);
  config.addSample("qcd-withveto-17BtoE-sr",  "QCD",  "qcd_smear_2017",       qcdvetowgt_BtoE,  datasel + vetoes + qcdSpikeRemovals);
  config.addSample("qcd-17F-cr",              "QCD",     "qcd_smear_2017",       qcdwgt_F,         datasel + dphi_invert + qcdSpikeRemovals);
  config.addSample("qcd-withveto-17F-cr",     "QCD",     "qcd_smear_2017",       qcdvetowgt_F,     datasel + vetoes + dphi_invert + qcdSpikeRemovals);
  config.addSample("qcd-withveto-17F-sr",     "QCD",     "qcd_smear_2017",       qcdvetowgt_F,     datasel + vetoes + qcdSpikeRemovals);
  config.addSample("data-18preHEM-cr",     "Data",        "data_2018N",  "1.0",     sdatasel + trigSR + vetoes + dphi_invert);
  config.addSample("qcd-18preHEM-cr",      "QCD",        "qcd_smear_2018",       qcdwgt_preHEM,       datasel + dphi_invert + qcdSpikeRemovals);
  config.addSample("qcd-withveto-18preHEM-cr",  "QCD",   "qcd_smear_2018",       qcdvetowgt_preHEM,   datasel + vetoes + dphi_invert + qcdSpikeRemovals);
  config.addSample("data-18postHEM-cr",     "Data",      "data_2018D",  "1.0",      sdataselHEM + trigSR + vetoes + dphi_invert);
  config.addSample("qcd-withveto-18preHEM-sr",  "QCD",   "qcd_smear_2018",       qcdvetowgt_preHEM,   datasel + vetoes + qcdSpikeRemovals);
  config.addSample("qcd-18postHEM-cr",      "QCD",       "qcd_smear_2018",       qcdwgt_postHEM,      dataselHEM + dphi_invert + qcdSpikeRemovals);
  config.addSample("qcd-withveto-18postHEM-cr",  "QCD",  "qcd_smear_2018",       qcdvetowgt_postHEM,  dataselHEM + vetoes + dphi_invert + qcdSpikeRemovals);
  config.addSample("qcd-withveto-18postHEM-sr",  "QCD",  "qcd_smear_2018",       qcdvetowgt_postHEM,  dataselHEM + vetoes + qcdSpikeRemovals);

  // qcdcr: other bkg subtraction
  config.addSample("ttbar-16-cr",       "t#bar{t}",      "ttbar_2016",        lepvetowgt,  datasel + vetoes + dphi_invert);
  ...
  config.addSample("data-16-norm",           "Data",        "data_2016", "1.0",      sdatasel + trigSR + revert_vetoes + dphi_cut);
  config.addSample("ttbar-16-norm",     "t#bar{t}",      "ttbar_2016",     lepselwgt,   datasel + revert_vetoes + dphi_cut);
  ...
  config.addSample("qcd-16-norm",       "QCD",           "qcd_smear_2016",       lepselwgt,   datasel + revert_vetoes + dphi_cut + qcdSpikeRemovals);
  config.addSample("data-17BtoE-norm",           "Data",    "data_2017BtoE", "1.0",      sdatasel + trigSR + revert_vetoes + dphi_cut);
  ...
  config.addSample("qcd-17BtoE-norm",       "QCD",           "qcd_smear_2017",       lepselwgt_BtoE,   datasel + revert_vetoes + dphi_cut + qcdSpikeRemovals);
  config.addSample("data-17F-norm",           "Data",        "data_2017F", "1.0",      sdatasel + trigSR + revert_vetoes + dphi_cut);
  ...
  config.addSample("qcd-17F-norm",          "QCD",           "qcd_smear_2017",       lepselwgt_F,      datasel + revert_vetoes + dphi_cut + qcdSpikeRemovals);
  config.addSample("data-18preHEM-norm",      "Data",        "data_2018N", "1.0",      sdatasel + trigSR + revert_vetoes + dphi_cut);
  ...
  config.addSample("qcd-18preHEM-norm",       "QCD",           "qcd_smear_2018",       lepselwgt_preHEM,   datasel + revert_vetoes + dphi_cut + qcdSpikeRemovals);
  config.addSample("data-18postHEM-norm",           "Data",        "data_2018D", "1.0",      sdataselHEM + trigSR + revert_vetoes + dphi_cut);
  ...
  config.addSample("qcd-18postHEM-norm",      "QCD",           "qcd_smear_2018",       lepselwgt_postHEM,  dataselHEM + revert_vetoes + dphi_cut + qcdSpikeRemovals);

  // qcdsr
  config.addSample("qcd-16-sr",         "QCD",           "qcd_smear_2016",       qcdwgt,           datasel + qcdSpikeRemovals);
  config.addSample("qcd-17BtoE-sr",     "QCD",           "qcd_smear_2017",       qcdwgt_BtoE,   datasel + qcdSpikeRemovals);
  config.addSample("qcd-17F-sr",        "QCD",           "qcd_smear_2017",       qcdwgt_F,      datasel + qcdSpikeRemovals);
  config.addSample("qcd-18preHEM-sr",   "QCD",           "qcd_smear_2018",       qcdwgt_preHEM,    datasel + qcdSpikeRemovals);
  config.addSample("qcd-18postHEM-sr",  "QCD",           "qcd_smear_2018",       qcdwgt_postHEM,   dataselHEM + qcdSpikeRemovals);

  // samples for splitting the TF, optional (see z.splitTF)
  if (SPLITTF){
    config.addSample("qcd-16-sr-int",         "QCD",           "qcd_smear_2016",       qcdwgt,           datasel + dphi_cut + qcdSpikeRemovals);
    config.addSample("qcd-17BtoE-sr-int",     "QCD",           "qcd_smear_2017",       qcdwgt_BtoE,   datasel + dphi_cut + qcdSpikeRemovals);
    config.addSample("qcd-17F-sr-int",        "QCD",           "qcd_smear_2017",       qcdwgt_F,      datasel + dphi_cut + qcdSpikeRemovals);
    config.addSample("qcd-18preHEM-sr-int",   "QCD",           "qcd_smear_2018",       qcdwgt_preHEM,    datasel + dphi_cut + qcdSpikeRemovals);
    config.addSample("qcd-18postHEM-sr-int",  "QCD",           "qcd_smear_2018",       qcdwgt_postHEM,   dataselHEM + dphi_cut + qcdSpikeRemovals);
  }
