...
const TString wgtvarsr = lumistr_2016+"*1000*Stop0l_evtWeight*puWeight*Stop0l_trigger_eff_MET_loose_baseline_QCD*BTagWeight*PrefireWeight*topTagWeight*wTagWeight*restopTagWeight*softbTagWeight"; //2016                                                                                                                                                               
  const TString wgtvar_RunBtoEsr = lumistr_2017RunBtoE+"*1000*Stop0l_evtWeight*17BtoEpuWeight*Stop0l_trigger_eff_MET_loose_baseline_QCD*BTagWeight*PrefireWeight*topTagWeight*wTagWeight*restopTagWeight*softbTagWeight"; //2017                                                                                                                                          
  const TString wgtvar_RunFsr = lumistr_2017RunF+"*1000*Stop0l_evtWeight*17FpuWeight*Stop0l_trigger_eff_MET_loose_baseline_QCD*BTagWeight*PrefireWeight*topTagWeight*wTagWeight*restopTagWeight*softbTagWeight"; //2017                                                                                                                                                    
  const TString wgtvar_preHEMsr = lumistr_2018PreHEM+"*1000*Stop0l_evtWeight*puWeight*Stop0l_trigger_eff_MET_loose_baseline_QCD*BTagWeight*topTagWeight*wTagWeight*restopTagWeight*softbTagWeight"; //2018                                                                                                                                                                
  const TString wgtvar_postHEMsr = lumistr_2018PostHEM+"*1000*Stop0l_evtWeight*puWeight*Stop0l_trigger_eff_MET_loose_baseline_QCD*BTagWeight*topTagWeight*wTagWeight*restopTagWeight*softbTagWeight"; //2018                                                                                                                                                                                                            
  ...
  const TString lepvetowgt_no_wtopsf_18pre = lumistr_2018PreHEM+"*1000*Stop0l_evtWeight*17FpuWeight*BTagWeight*topTagWeight*wTagWeight*restopTagWeight*softbTagWeight*MuSF*ElecSF*TaSF";
const TString lepvetowgt_no_wtopsf_18po = lumistr_2018PostHEM+"*1000*Stop0l_evtWeight*17FpuWeight*BTagWeight*topTagWeight*wTagWeight*restopTagWeight*\
softbTagWeight*MuSF*ElecSF*TaSF";
// 1Lep LLB method                                                                                                                                                                                                                                                                                                
...
//const TString datasel = " && Pass_EventFilter && Pass_HT && Pass_JetID && Pass_CaloMETRatio && (run < 319077 || (run >= 319077 && Pass_exHEMVeto20))";
  const TString sdatasel = " && Pass_EventFilter && Pass_HT && Pass_JetID && Pass_CaloMETRatio && (run < 310977||(run>=310977 && Pass_exHEMVeto30)) ";
...
std::map<TString, TString> phocrMapping{
  ...
  // high mtb                       
  // 0 taggged                     
  {"hmVal_nb1_highmtb_nj5_nt0_nrt0_nw0",      "hmVal_nb1_highmtb_nj7_nt0_nrt0_nw0"},
  {"hmVal_nb2_highmtb_nj5_nt0_nrt0_nw0",      "hmVal_nb2_highmtb_nj7_nt0_nrt0_nw0"},
...
std::map<TString, TString> lepcrMapping {
  ...
  // high mtb                       
  // 0 taggged                     
  {"hmVal_nb1_highmtb_nj5_nt0_nrt0_nw0",      "hmVal_nb1_highmtb_nj7"},
  {"hmVal_nb2_highmtb_nj5_nt0_nrt0_nw0",      "hmVal_nb2_highmtb_nj7"},
...
BaseConfig qcdConfig(){
  ...
  config.inputdir = inputdir;
  config.outputdir = outputdir+"/QCD2";
  config.header = "#sqrt{s} = 13 TeV, "+lumistr+" fb^{-1}";
...
BaseConfig sigConfig(){
  ...
  config.inputdir = inputdir;
  config.outputdir = outputdir+"/sig2";
  config.header = "#sqrt{s} = 13 TeV, "+lumistr+" fb^{-1}";
