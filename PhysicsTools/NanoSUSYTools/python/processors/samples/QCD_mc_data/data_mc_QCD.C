...
void data_mc_QCD(TString table="validation_HMfull_comp.txt"){

  gStyle->SetOptStat(111111);
 
  TH1D *h1 =new TH1D ("h1","",24,0.5,24.5);
  TH1D *h2 =new TH1D ("h2","",24,0.5,24.5);
  //  TH2D *h3 =new TH2D ("h3","",10,0.5,10.5,10,0.5,10.5);
    ...
    h1->Draw("hist");
    //h1->SetBinLength(1.0);
    h1->SetTitle("QCD_MC vs QCD_data(HM validation run2)");
    h1->SetLineWidth(3);
    ...
    hratio->GetXaxis()->SetTitle("bins[24]");
    ...
    hratio->Draw();
    TLine *line1 = new TLine(0,1,24,1);
    line1->SetLineColor(kRed);
    line1->SetLineWidth(3);
    line1->Draw("same");
    c->SaveAs("validation_fullHM.png");
