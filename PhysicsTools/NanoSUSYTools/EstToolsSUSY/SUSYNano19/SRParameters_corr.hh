...
const TString inputdir = "root://cmseos.fnal.gov//eos/uscms/store/user/ddash/nanoAOD/ana_samples/";
const TString outputdir = ".";

const TString datadir = ".";
  const TString lumistr ="41208.0";//"21068.5";//"41208.034";// "35815.165"; //Units are in pb
//2017
...
// lumi and base weight
  //const TString wgtvar = lumistr+"*1000*Stop0l_evtWeight*puWeight*PrefireWeight"; //2016
  const TString wgtvar = lumistr+"*Stop0l_evtWeight*Stop0l_trigger_eff_MET_loose_baseline_QCD*puWeight*BTagWeight"; //2018
  const TString wgtvar1 = lumistr+"*Stop0l_evtWeight*Stop0l_trigger_eff_MET_loose_baseline_QCD*puWeight*BTagWeight";
// photon trigger eff.
