...
const TString dataselHEM = " && Pass_EventFilter && Pass_HT && Pass_JetID && Pass_CaloMETRatio && (run < 319077 || run==1)";
const TString sdataselHEM = " && Pass_EventFilter && Pass_HT && Pass_JetID && Pass_CaloMETRatio && Pass_exHEMVeto30 && (run >=319077 || run==1)";
...
BaseConfig qcdConfig(){
  ...
  config.addSample("qcd-withveto-16-sr",  "QCD",         "qcd_smear_sf_2016",       qcdvetowgt,  datasel + vetoes + qcdSpikeRemovals);
  ...
  config.addSample("qcd-withveto-17BtoE-sr",  "QCD",  "qcd_smear_sf_2017",       qcdvetowgt_BtoE,  datasel + vetoes + qcdSpikeRemovals);
  ...
  config.addSample("qcd-withveto-17F-sr",     "QCD",     "qcd_smear_sf_2017",       qcdvetowgt_F,     datasel + vetoes + qcdSpikeRemovals);
  ...
  config.addSample("qcd-withveto-18preHEM-sr",  "QCD",   "qcd_smear_sf_2018",       qcdvetowgt_preHEM,   datasel + vetoes + qcdSpikeRemovals);
  ...
  config.addSample("qcd-withveto-18postHEM-sr",  "QCD",  "qcd_smear_sf_2018",       qcdvetowgt_postHEM,  dataselHEM + vetoes + qcdSpikeRemovals);
  ...
  // qcdsr
  config.addSample("qcd-16-sr",         "QCD",           "qcd_smear_sf_2016",       qcdwgt,           datasel + qcdSpikeRemovals);
  config.addSample("qcd-17BtoE-sr",     "QCD",           "qcd_smear_sf_2017",       qcdwgt_BtoE,   datasel + qcdSpikeRemovals);
  config.addSample("qcd-17F-sr",        "QCD",           "qcd_smear_sf_2017",       qcdwgt_F,      datasel + qcdSpikeRemovals);
  config.addSample("qcd-18preHEM-sr",   "QCD",           "qcd_smear_sf_2018",       qcdwgt_preHEM,    datasel + qcdSpikeRemovals);
  config.addSample("qcd-18postHEM-sr",  "QCD",           "qcd_smear_sf_2018",       qcdwgt_postHEM,   dataselHEM + qcdSpikeRemovals);

  // samples for splitting the TF, optional (see z.splitTF)
  if (SPLITTF){
    config.addSample("qcd-16-sr-int",         "QCD",           "qcd_smear_sf_2016",       qcdwgt,           datasel + dphi_cut + qcdSpikeRemovals);
    config.addSample("qcd-17BtoE-sr-int",     "QCD",           "qcd_smear_sf_2017",       qcdwgt_BtoE,   datasel + dphi_cut + qcdSpikeRemovals);
    config.addSample("qcd-17F-sr-int",        "QCD",           "qcd_smear_sf_2017",       qcdwgt_F,      datasel + dphi_cut + qcdSpikeRemovals);
    config.addSample("qcd-18preHEM-sr-int",   "QCD",           "qcd_smear_sf_2018",       qcdwgt_preHEM,    datasel + dphi_cut + qcdSpikeRemovals);
    config.addSample("qcd-18postHEM-sr-int",  "QCD",           "qcd_smear_sf_2018",       qcdwgt_postHEM,   dataselHEM + dphi_cut + qcdSpikeRemovals);
  }
