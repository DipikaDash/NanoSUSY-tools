...
BaseConfig qcdConfig(){
  ...
  // qcdcr
  config.addSample("data-cr",     "Data",             "data_2016",  "1.0",      sdatasel + trigSR + vetoes + dphi_invert);
...
config.addSample("data-norm",      "Data",          "data_2016", "1.0",     sdatasel + trigSR + revert_vetoes + dphi_cut);
  if(is2016){
  ...
  // qcdsr                                                                                                                                                                       
  config.addSample("qcd-sr",         "QCD",           "qcd_smear_2016",        qcdwgt,      datasel + trigSR + qcdSpikeRemovals);
