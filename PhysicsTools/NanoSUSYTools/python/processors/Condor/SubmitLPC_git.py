    ...
    for line_ in lines:
        ...
        if process[stripped_entry[0]]["isData__"]:
            ...
            process[stripped_entry[0]].update( {
                "dataEra": stripped_entry[0][foundEra.end(0)], #Example naming convention: Data_MET_2018_PeriodC. Alternate option: match "Period", take location + 6.
