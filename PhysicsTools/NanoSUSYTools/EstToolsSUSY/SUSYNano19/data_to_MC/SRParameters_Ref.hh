...
// lumi and base weight
  const TString wgtvar = lumistr+"*1000*Stop0l_evtWeight*puWeight*BTagWeight*PrefireWeight";//*ISRWeight"; //2016 //17FpuWeight
...
const TString trigDiLepCR = " && passtrigdilepOR && dileppt>200";
  // const TString datasel = " && Pass_EventFilter && Pass_NJets20 && Pass_HT && Pass_JetID && Pass_CaloMETRatio ";//&& Pass_exHEMVeto30";
  const TString datasel ="&& Pass_QCDCR_lowDM && Pass_CaloMETRatio";// && njet_j30 >=2";// && Pass_exHEMVeto30";//njet_j30 >=2
...
BaseConfig qcdConfig(){
  ...
  config.addSample("rare-norm",      "rare",          "rare_2016",            lepselwgt,   datasel + trigSR + revert_vetoes + dphi_cut);
