...
sendfiles = ["../keep_and_drop.txt", "../keep_and_drop_sf.txt", "../keep_and_drop_res.txt", "../keep_and_drop_smear.txt"]
TTreeName = "Events"
NProcess = 10
...
def my_process(args):
    ...
    global tempdir
    global ProjectName
    ProjectName = time.strftime('%b%d') + ShortProjectName + VersionNumber + "_qcdsmear_test_cutbefore_053119"
    if args.era == 0:
