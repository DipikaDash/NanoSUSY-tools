...
BaseConfig qcdConfig(){
  ...
  // qcdcr
  config.addSample("data-cr",     "Data",             "data_2018N",  "1.0",      sdatasel + trigSR + vetoes + dphi_invert);
  config.addSample("qcd-cr",      "QCD",              "qcd_smear_2018",         qcdwgt,   datasel + trigSR + dphi_invert + qcdSpikeRemovals);

  config.addSample("qcd-withveto-cr",  "QCD",         "qcd_smear_2018",       qcdvetowgt,  datasel + trigSR + vetoes + dphi_invert + qcdSpikeRemovals);
  config.addSample("qcd-withveto-sr",  "QCD",         "qcd_smear_2018",       qcdvetowgt,  datasel + trigSR + vetoes + qcdSpikeRemovals);
...
config.addSample("data-norm",      "Data",          "data_2018N", "1.0",     sdatasel + trigSR + revert_vetoes + dphi_cut);
  if(is2016){
  ...
  config.addSample("minor-norm",     "minor",         "minor_2018",           lepselwgt,   datasel + trigSR + revert_vetoes + dphi_cut);
  config.addSample("qcd-norm",       "QCD",           "qcd_smear_2018",       lepselwgt,   datasel + trigSR + revert_vetoes + dphi_cut + qcdSpikeRemovals);
  // qcdsr                                                                                                                                                                       
  config.addSample("qcd-sr",         "QCD",           "qcd_smear_2018",        qcdwgt,      datasel + trigSR + qcdSpikeRemovals);

  // samples for splitting the TF, optional (see z.splitTF)                                                                                                                       
  if (SPLITTF){
    config.addSample("qcd-sr-int",     "QCD",           "qcd_smear_2018",       qcdwgt,      datasel + trigSR + dphi_cut + qcdSpikeRemovals);
  }
